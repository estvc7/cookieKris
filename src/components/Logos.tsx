const Logos: React.FC = () => {
    return (
        <section id="logos" className="py-32 px-5 bg-background">
            <p className="text-lg font-bold text-center">Ingredientes Usados</p>
            <div className="mt-5 w-full flex flex-wrap flex-row items-center justify-evenly gap-5 sm:gap-10 opacity-45 logos-container">
                ...
                {/* FR */}
                <svg width="680" height="80" viewBox="0 0 500 80" xmlns="http://www.w3.org/2000/svg">
                    <text x="10" y="60" fontFamily="Arial, Helvetica, sans-serif" fontSize="60" fontWeight="bold" fill="#B69349">
                        FERRERO ROCHER
                    </text>
                </svg>
